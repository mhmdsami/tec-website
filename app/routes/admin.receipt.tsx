...
export const action: ActionFunction = async ({ request }): ActionResponse => {
  ...
  const receipt = await db.receipt.create({ data: parseRes.data });
    ...
    <main className="flex flex-col gap-5">
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogTrigger asChild>
          <Button className="w-full self-end sm:w-fit">Create Receipt</Button>
        </DialogTrigger>
        <DialogContent>
          <DialogHeader>
              ...
              <Controller
                render={({ field: { onChange, value } }) => (
                  <Select onValueChange={onChange} value={value}>
                    ...
                    <SelectContent>
                      <SelectItem value="Business">Business Wing</SelectItem>
                      <SelectItem value="Social">Social Wing</SelectItem>
                      <SelectItem value="Education">Education Wing</SelectItem>
                      <SelectItem value="Spiritual">Spiritual Wing</SelectItem>
                    </SelectContent>
                  </Select>
                )}
                name="wing"
